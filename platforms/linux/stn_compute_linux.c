...
static void stn_compute_linux_qualify_opencl_vector(
    void * module,
    stn_compute_provider *provider
)
{
...
static void stn_compute_linux_qualify_opencl_sha256(
    void * module,
    stn_compute_provider *provider
)
{
...
)
{
    ...
    if (type ==
        ...
        stn_compute_linux_qualify_opencl_vector(
            module,
            provider
        );

        stn_compute_linux_qualify_opencl_sha256(
            module,
            provider
        );
    }
